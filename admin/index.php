                    ...
                    <form method="post" action="auth.php" id="userloginform">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10 mt-4 mb-3">
                                <h4 class="text-center text-decoration-underline tug-1 text-primary-emphasis"> Admin Login</h4>
                            </div>
                            ...
                            <div class="col-md-10 my-4">
                                ...
                                <div class="text-center gap-2 pt-4">
                                    <div class="d-inline">
                                        Not an admin?
                                        <a href="../index.php" class="text-decoration-none text-white shadow-none rounded-2 btn btn-sm btn-primary">
                                            Home
                                        </a>
                                    </div>
                                </div>
