    ...
    <div class="d-flex flex-column bg-white min-vh-100">
            ...
            <div class="container-fluid my-1 mx-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-primary-emphasis fw-bold text-decoration-underline tug-2 active" aria-current="page" href="users.php">Users</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-primary-emphasis fw-bold" aria-current="page" href="results.php">Results</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid flex-fill d-flex bg-primary-subtle-2">
            ...
            <div class="container-fluid bg-white shadow-sm rounded-3  my-3">
                ...
                <h4 class="text-start ms-3 my-4 text-primary-emphasis text-decoration-underline tug-1">Users</h4>
                <hr>

                <div class="row mt-5 justify-content-center">

                    <div class="col-md-11">
                        <form action="deleteuser.php" method="post" id="deleteuserform"></form>
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="usertable">
                                ...
                                <tbody>
                                    <?php
                                    $query = "select * from pcos_2023_user ";
                                    $result = mysqli_query($link, $query);
                                        ...
                                        <tr class="align-middle  text-nowrap">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <button class="btn btn-danger btn-sm delete text-white shadow-none" name="butdel" form="deleteuserform" value="<?= $row["uid"] ?>">
